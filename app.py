#esse programa foi desenvolvido por Davi Leonardo, fundador da Zyntra usando a base do Oracle.
...
st.title("Chamas - Zyntra Group")


# Configuração do prompt e do modelo
rag_template = """
Você é um atendente de uma empresa.
Seu trabalho é conversar com os desenvolvedores da empresa, consultando a base de 
conhecimentos da empresa, e dar 
uma resposta técnica e precisa para ele, baseada na 
